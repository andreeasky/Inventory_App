...
public class ProductProvider extends ContentProvider {
    ...
    // Insert new data into the ProductProvider with the given ContentValues
    @Override
    public Uri insert(Uri uri, ContentValues contentValues) {
        // Match the Uri to know in which table we are inserting new data
    ...
    private Uri insertProduct(Uri uri, ContentValues contentValues) {
        ...
        // Insert the new products with the given values
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        switch (match) {
            case PRODUCTS:
                // Set a notification URI so the cursor can be updated automatically
                getContext().getContentResolver().notifyChange(uri, null);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int rowsDeleted;
        // Match the URI to know what type of query is being done by using switch / case methods
        final int match = sUriMatcher.match(uri);
        switch (match) {
            case PRODUCTS:
